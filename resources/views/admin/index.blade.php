...
<html>
  <head>
    ...
    <!-- Date Picker -->
    <link href="{{URL::asset('plugins/datepicker/datepicplugins/jvectormap/jquery-jvectormap-1.2.2.cssker3.css')}}" rel="stylesheet" type="text/css" />
    <!-- Daterange picker -->
  ...
  <body class="skin-blue">
    ...
    <script src="{{URL::asset('/js/pages/dashboard.js')}}" type="text/javascript"></script>
